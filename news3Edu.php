...
<div id="main" class="col-lg-12 col-md-12 col-sm-12">
  ...
  <div class="col-lg-12 col-md-12 col-sm-12" id="main_news" style = "height:auto;">
      ...
      $conn = mysqli_connect("localhost","id8402017_campusnsbmnews","error404","id8402017_nsbmnews");
       $show="SELECT title FROM edu ORDER BY id DESC LIMIT 4,1";
...
$conn = mysqli_connect("localhost","id8402017_campusnsbmnews","error404","id8402017_nsbmnews");
  $show1="SELECT image FROM edu ORDER BY id DESC LIMIT 4,1";
...
<?php
   ...
   $conn = mysqli_connect("localhost","id8402017_campusnsbmnews","error404","id8402017_nsbmnews");
      $show1="SELECT * FROM edu ORDER BY id DESC LIMIT 4,1"; 
